...
const content = {
  en: {
    ...
    sections: [
      ...
      ['Independent ownership', 'Built and maintained by Hafiy. This site is not affiliated with the Sarawak Government. Status and milestones are best-effort based on available information.'],
    ],
  ...
  ms: {
    ...
    sections: [
      ...
      ['Pengurusan bebas', 'Dibina dan diselenggara oleh Hafiy. Laman ini tidak mempunyai hubungan rasmi dengan Kerajaan Sarawak. Status dan pencapaian utama disediakan sebaik mungkin berdasarkan maklumat yang tersedia.'],
    ],
...
export default function AboutPage({ language, onNavigate, headingRef }) {
  ...
  return <div className="app-shell">
    <main className="concept-about">
      <header><h1 ref={headingRef} tabIndex={-1}>{text.title}</h1><p>{text.intro}</p></header>
      ...
      <SiteFooter copy={getUiCopy(language)} language={language} onNavigate={onNavigate} />
    </main>
  </div>;
}
