...
const PROJECT_TRANSLATIONS = {
  ...
  "Baram Renewable Energy Economic Zone": { displayName: "Zon Ekonomi Tenaga Boleh Baharu Baram", lead: "Planet QEOS Sdn Bhd / DeepTech (penyampaian swasta yang dinamakan)", value: "Tidak didedahkan", summary: "Zon Ekonomi Tenaga Boleh Baharu Baram ialah cadangan zon di Temala, Long Lama dalam Telang Usan. Ia masih belum diwartakan dan tiada pihak berkuasa peringkat zon; Planet QEOS / DeepTech ialah penyampaian swasta yang dinamakan, manakala Projek Agrovoltaik Baram yang dijejak secara berasingan ialah unit penyampaian sedia ada.", milestones: ["Dinamakan cadangan zon di Temala", "ADUN meletakkan solar DeepTech sebagai sauh zon Temala", "Zon mencapai pewartaan atau projek kedua yang dinamakan"] },
