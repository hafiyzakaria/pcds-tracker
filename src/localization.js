...
const PROJECT_TRANSLATIONS = {
  ...
  "SMA Rural Telecommunication (SMART)": { displayName: "Kesalinghubungan Luar Bandar SMART", lead: "Sarawak Multimedia Authority / SDEC", value: "RM116 juta", summary: "Program kesalinghubungan luar bandar seluruh Sarawak yang menggunakan menara SMART600 berkongsi dan membolehkan jalur lebar rumah MySRBN untuk komuniti yang kurang mendapat liputan. MCMC dan Kementerian Kewangan memperuntukkan RM116 juta pada 2024 bagi peralatan Multi-Operator Core Network (MOCN) enam hala pada 600 menara itu.", milestones: ["SMART dilancarkan di Nanga Sekukut", "Menara SMART mula beroperasi dengan MySRBN", "Perjanjian sokongan operasi SMART600 ditandatangani", "Baki menara SMART600 telah beroperasi"] },
