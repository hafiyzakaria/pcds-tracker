...
const PROJECT_TRANSLATIONS = {
  ...
  "Kuching Low-Carbon Hub": { displayName: "Hab Rendah Karbon Kuching", lead: "PETROS", value: "Tidak didedahkan", summary: "Cadangan Hab Rendah Karbon Kuching di Tanjung Embang ialah zon strategik RMK-13 bagi industri, perdagangan dan logistik rendah karbon, diterajui PETROS dengan China Jiangsu International dan Sumitomo sebagai rakan peneraju. Ia berada bersama Lapangan Terbang Antarabangsa Kuching Baharu dan Pelabuhan Laut Dalam Tanjung Embang yang dijejak secara berasingan; kos modal seluruh hab tidak didedahkan.", milestones: ["Dilancarkan di Sidang Peta Hala Tuju Gas Sarawak", "PETROS dan CJI menandatangani Perjanjian Kerjasama Strategik", "Dinamakan zon strategik cadangan RMK-13", "PETROS dan CJI menandatangani Perjanjian Rangka Kerja", "PETROS dan Sumitomo memajukan pembangunan bersama hab", "Pelan induk terperinci mencapai pemuktamadan", "Pembangunan fizikal dan infrastruktur bermula melalui PPP"] },
  ...
  "Baram Renewable Energy Economic Zone": { displayName: "Zon Ekonomi Tenaga Boleh Baharu Baram", lead: "Planet QEOS Sdn Bhd / DeepTech (penyampaian swasta yang dinamakan)", value: "Tidak didedahkan", summary: "Zon Ekonomi Tenaga Boleh Baharu Baram ialah cadangan zon strategik RMK-13 di Temala, Long Lama dalam Telang Usan. Ia masih belum diwartakan dan tiada pihak berkuasa peringkat zon; Planet QEOS / DeepTech ialah penyampaian swasta yang dinamakan, manakala Projek Agrovoltaik Baram yang dijejak secara berasingan ialah unit penyampaian sedia ada.", milestones: ["RMK-13 menamakan cadangan zon tenaga Baram", "ADUN meletakkan solar DeepTech sebagai sauh zon Temala", "Zon mencapai pewartaan atau projek kedua yang dinamakan"] },
