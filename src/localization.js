...
const PROJECT_TRANSLATIONS = {
  ...
  "SMA Rural Telecommunication (SMART)": { displayName: "Kesalinghubungan Luar Bandar SMART", lead: "Sarawak Multimedia Authority / SDEC", value: "Tidak didedahkan", summary: "Program kesalinghubungan luar bandar seluruh Sarawak yang menggunakan menara SMART600 berkongsi dan membolehkan jalur lebar rumah MySRBN untuk komuniti yang kurang mendapat liputan. SMA memiliki program ini dan SDEC mengetuai pelaksanaannya, dengan MCMC serta pengendali mudah alih menyokong operasi perkhidmatan.", milestones: ["SMART dilancarkan di Nanga Sekukut", "Menara SMART mula beroperasi dengan MySRBN", "Perjanjian sokongan operasi SMART600 ditandatangani", "Baki menara SMART600 mula beroperasi"] },
