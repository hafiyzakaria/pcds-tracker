...
- The theme control names the current light or dark state and the state it will switch to. Its label
  updates immediately after a click and when an uncustomised system preference changes. The existing
  icon animation and reduced-motion behavior remain unchanged.
