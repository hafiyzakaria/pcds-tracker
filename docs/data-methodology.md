...
- Four 13MP / zone cards added on 1 September 2026 after the parked-pool re-review:
  ...
  - Baram Renewable Energy Economic Zone - `Planning`; value: `Not disclosed` for the zone. Proposed 13MP zone; lead is Sarawak Government because no zone-level authority is named. Planet QEOS / DeepTech stays in the summary as named private delivery of the separately tracked Baram Agrovoltaic Project, which keeps the RM6 billion figure. Same-day identity follow-up: `docs/project-audits/2026-09-01-13mp-zone-candidate-pool.md`. Sources: UKAS, DayakDaily.
